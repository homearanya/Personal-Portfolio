              ...
              <div className="col-12 col-lg-7">
                <div className="content-block">
                  ...
                  <p className="about-description">
                    My name is <strong>Carlos Gonzalez</strong>. I am a freelancer based in sunny
                    South Africa and I have been tinkering with websites for years. My focus is on
                    modern-looking, blazing-fast loading, SEO-ready sites.
                  </p>
                  <p className="about-description last">
                    Choose an HTML5 template that you like and best applies to your business, and
                    I’ll turn it into your dream new website. All my sites come with a headless CMS
                    so that you can manage your content. And guess what?, you won’t need to pay for
                    a web host.
                  </p>
                  <address>
                    <ul className="list-inline about-info">
                      ...
                      <li className="list-inline-item">
                        <span>Email:</span>
                        <p>
                          <a href="mailto:homearanya@outlook.com">homearanya@outlook.com</a>
                        </p>
                      </li>
